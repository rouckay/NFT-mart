...
?>
<?php
$hid_pros = show_hidden_products($user_id, $mem_user_name ?? 0);
if ($hid_pros == 0) {
} else {
    ...
    <div class="col-lg-4 col-md-6">
        ...
        <div class="product product--card">
            ...
            if ($ext == "jpg" or $ext == "png" or $ext == "jpeg" or $ext == 'gif') { ?>
                <img height="450px" width="555px" src="./admin/img/member_product/<?php echo $data['mem_pro_name']; ?>/<?php echo $data['mem_pro_image']; ?>" alt="Product Image">

            <?php } else { ?>
                <video width="100%" height="30%" autoplay muted loop>
                    <source src="./admin/img/member_product/<?php echo $data['mem_pro_name']; ?>/<?php echo $data['mem_pro_image']; ?>">
                </video>
            <?php } ?>
